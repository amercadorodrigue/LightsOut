...
public class ColorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int radioId = 0;
        switch (colorId){
            case R.color.red:    radioId = R.id.radio_red;     break;
            case R.color.orange: radioId = R.id.radio_orange;  break;
            case R.color.yellow: radioId = R.id.radio_yellow;  break;
            case R.color.green:  radioId = R.id.radio_green;   break;
        }
